...
// Addition von 2 Matrizen auf der GPU mit Hilfe von threads und blocks
// 
// compile:             nvcc cuda5.cu -o cuda5 && ./cuda5
// Aufruf mit Analyse:   nsys profile --stats=true -t cuda,nvtx ./cuda5
